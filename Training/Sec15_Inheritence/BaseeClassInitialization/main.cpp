...
class Derived: public Base{
    ...
    private:
        int double_value;
    public:
                //Explictly stating which constructor to call via "Base {}", or "Base{x}"
        Derived() : Base{}, double_value{0} {std::cout << "Derived no-args constructor" << std::endl;} // Calling Base no-args constructor

        Derived(int x) : Base{x}, double_value{x*2} {std::cout << "Derived (int) overloaded constructor" << std::endl;} // Calling Base (int) constructor

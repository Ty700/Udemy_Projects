// Section 16
// Interfaces - start
// This code repeats itself a LOT with the friend function. Since friend isn't inherited we have to repeat code each time to be able to print
...
int main() {
    ...
    std::cout << *p2<< std::endl; //This prints Account display since withdrawl is the ONLY virtual.... thus we need an interface class to print stuff.
